...
class BenchmarkResults:
    ...
    def to_v3_format(
        ...
        Based on: https://github.com/pytorch/pytorch/wiki/How-to-integrate-with-PyTorch-OSS-benchmark-database
        ...
        records.append(
            {
                ...
                "model": {
                    "name": model,
                    "type": "OSS model",
                    "backend": f"cuda_{quantization}",
                },
                "metric": {
                    "name": "throughput(tokens/sec)",
                    "benchmark_values": [self.throughput_mean],
                    "target_value": 0,
                    "extra_info": {
                        "min": self.throughput_min,
                        "max": self.throughput_max,
                        "stdev": self.throughput_stdev,
                        "trimmed_runs": self.trimmed_runs,
                    },
                },
                "runners": [{"name": runner_name, "type": "cuda"}],
            }
        )
        ...
        records.append(
            {
                ...
                "metric": {
                    "name": "model_load_time(ms)",
                    "benchmark_values": [self.model_load_time_mean],
                    "target_value": 0,
                    "extra_info": {
                        "min": self.model_load_time_min,
                        "max": self.model_load_time_max,
                        "stdev": self.model_load_time_stdev,
                    },
                },
                "runners": [{"name": runner_name, "type": "cuda"}],
            }
        ...
        records.append(
            {
                ...
                "metric": {
                    ...
                    "benchmark_values": [self.inference_time_mean],
                    "target_value": 0,
                    "extra_info": {
                        "min": self.inference_time_min,
                        "max": self.inference_time_max,
                        "stdev": self.inference_time_stdev,
                    },
                },
                "runners": [{"name": runner_name, "type": "cuda"}],
            }
        ...
        records.append(
            {
                ...
                "metric": {
                    "name": "first_token_latency(ms)",
                    "benchmark_values": [self.first_token_latency_mean],
                    "target_value": 0,
                    "extra_info": {
                        "min": self.first_token_latency_min,
                        "max": self.first_token_latency_max,
                        "stdev": self.first_token_latency_stdev,
                    },
                },
                "runners": [{"name": runner_name, "type": "cuda"}],
            }
